...
% Bc        Viscous Damping Coefficient 
...
%% returns the model parameters accordingly to the USER-DEFINED IP02 system configuration
function [ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Bc ] = config_ip02( IP02_LOAD_TYPE, AMP_TYPE )
% Calculate useful conversion factors
calc_conversion_constants();
% Calculate IP02 model parameters
[ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Bc ] = calc_IP02_parameters( IP02_LOAD_TYPE, AMP_TYPE );
% end of 'setup_ip02_configuration( )'


%% Calculate the IP02 model parameters 
function [ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, M, r_mp, Bc ] = calc_IP02_parameters( IP02_LOAD_TYPE, AMP_TYPE )
