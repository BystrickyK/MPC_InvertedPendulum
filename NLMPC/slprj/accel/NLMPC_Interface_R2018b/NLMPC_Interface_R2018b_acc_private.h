...
#ifndef RTW_HEADER_NLMPC_Interface_R2018b_acc_private_h_
#define RTW_HEADER_NLMPC_Interface_R2018b_acc_private_h_
#include "rtwtypes.h"
...
; real_T NLMPC_Interface_R2018b_acc_rt_TDelayInterpolate ( real_T tMinusDelay
